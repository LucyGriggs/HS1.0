function results = test4databasething(im)
...
[cluster_idx, cluster_center] = kmeans(ab, nColors, 'distance', 'sqEuclidean', 'Replicates', 3); %#ok<*ASGLU>
...
results = activecontour(Ibw, mask, 10000);
